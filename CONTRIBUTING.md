...
If you want something to be included on `awesome-TikZ`, try to only add actual awesome stuff in your pull requests. After all, it's a curation, not a collection.
